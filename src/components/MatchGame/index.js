...
class MatchGame extends Component {
  ...
  render() {
    const {score, time, activeTab, displayImage, isGamePlaying} = this.state
        ...
        <nav className="navbar">
          ...
          <ul className="navbar_list_container">
            ...
            <li className="timer_image_and_count_container">
              ...
              />
              <p className="score_time_count">{time} sec</p>
            </li>
          </ul>
        </nav>
        {isGamePlaying ? (
          <div className="image_container">
            <img src={imageUrl} alt="match" className="image_displayed" />
            ...
            <ul className="images_container">
              {filteredImagesList.map(eachImage => (
                <ImageItem
                  ...
                  checkImageMatched={this.checkImageMatched}
                />
              ))}
            </ul>
          </div>
        ) : (
          <ResultCard score={score} playAgain={this.playAgain} />
        )}
      </div>
    )
  }
